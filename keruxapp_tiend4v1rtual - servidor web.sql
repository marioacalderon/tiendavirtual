...
-- Tiempo de generación: 17-02-2021 a las 23:39:03
...
--
-- Base de datos: `keruxapp_tiend4v1rtual`
--
...
CREATE TABLE `categorias` (
  ...
  `categoria_nombre` varchar(45) CHARACTER SET utf8 NOT NULL,
...
(1, 1, 'Diario', 1, 'diario', '2021-02-14 13:26:41', '2021-02-14 13:26:41');
...
CREATE TABLE `categorias_principal` (
  ...
  `categoria_principal_nombre` varchar(45) CHARACTER SET utf8 NOT NULL,
  `categoria_principal_activa` tinyint(1) DEFAULT NULL,
  `categoria_principal_meta_link` varchar(100) CHARACTER SET utf8 DEFAULT NULL,
...
(1, 'Colegios', 1, 'colegios', '2021-02-14 12:26:42', '2021-02-14 12:26:42'),
(2, 'Deportivos', 1, 'deportivos', '2021-02-14 13:13:14', '2021-02-14 13:13:14'),
(3, 'Medicos', 1, 'medicos', '2021-02-17 22:49:35', '2021-02-17 22:49:35');
...
CREATE TABLE `lineas` (
  ...
  `linea_nombre` varchar(45) CHARACTER SET utf8 NOT NULL,
  `linea_meta_link` varchar(255) CHARACTER SET utf8 NOT NULL,
...
(1, 'Uniformes', 'uniformes', 1, '2021-02-14 10:20:24', '2021-02-17 22:48:03'),
(3, 'Pijamas', 'pijamas', 1, '2021-02-17 22:49:44', NULL),
(4, 'Bebes', 'bebes', 1, '2021-02-17 22:49:53', NULL),
(5, 'Dotaciones', 'dotaciones', 1, '2021-02-17 22:50:01', NULL),
(6, 'Particular', 'particular', 1, '2021-02-17 22:50:07', NULL),
(7, 'Mascotas', 'mascotas', 1, '2021-02-17 22:50:13', NULL);
...
CREATE TABLE `productos` (
  ...
  `producto_codigo` varchar(45) CHARACTER SET utf8 DEFAULT NULL,
  ...
  `producto_nombre` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  `producto_meta_link` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  `producto_talla` varchar(20) CHARACTER SET utf8 DEFAULT '0',
  ...
  `producto_valor` varchar(45) CHARACTER SET utf8 DEFAULT NULL,
  ...
  `producto_descripcion` longtext CHARACTER SET utf8 DEFAULT NULL,
...
(1, '123456', '2021-02-15 09:46:11', 1, 1, 'Producto de prueba', 'producto-de-prueba', NULL, 1, 10, 10, 10, '', '2500', 1, 1, 1, 1, 'adsfsañldf aidfopaidf aosdfyaouihdfopauhf adeyfopasduyfaopu fasdyfpoasduifpasdf ', NULL);
...
CREATE TABLE `sistema` (
  ...
  `sistema_razon_social` varchar(145) CHARACTER SET utf8 DEFAULT NULL,
  `sistema_nombre` varchar(145) CHARACTER SET utf8 DEFAULT NULL,
  `sistema_nit` varchar(25) CHARACTER SET utf8 DEFAULT NULL,
  `sistema_telefono_fijo` varchar(25) CHARACTER SET utf8 DEFAULT NULL,
  `sistema_telefono_movil` varchar(25) NOT NULL,
  `sistema_email` varchar(100) CHARACTER SET utf8 DEFAULT NULL,
  `sistema_sitio_url` varchar(100) CHARACTER SET utf8 DEFAULT NULL,
  `sistema_postal` varchar(25) CHARACTER SET utf8 DEFAULT NULL,
  `sistema_direccion` varchar(100) CHARACTER SET utf8 DEFAULT NULL,
  `sistema_barrio` varchar(25) CHARACTER SET utf8 DEFAULT NULL,
  `sistema_ciudad` varchar(45) CHARACTER SET utf8 DEFAULT NULL,
  `sistema_departamento` varchar(45) CHARACTER SET utf8 DEFAULT NULL,
  `sistema_productos_destacados` int(11) NOT NULL,
  `sistema_texto` tinytext CHARACTER SET utf8 DEFAULT NULL,
...
(1, 'Confecciones Salamandra', 'Salamandra Virtual', '800256415-8', '(1) 867-4616', '310 256-3210', 'info@confeccionessalamandra.com', 'http://www.confeccionessalamandra.com', '', 'carrera 6 #11-75', 'Centro', 'Fusagasugá', 'Cundinamarca', 6, 'Precio y calidad insuperables!', '2021-02-10 10:45:15');
...
(3, '::1', 'osbeltran', '$2y$10$omeuScoHbHk23GIkSwBRw.UNdFK97fgLJEJlSqbRvh6ClPGC8ghfK', 'administrador@confeccionessalamandra.com', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1612846725, 1613607387, 1, 'Oscar', 'Beltran', NULL, NULL);
